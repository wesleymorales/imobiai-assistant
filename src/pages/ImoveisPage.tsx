...
import { mockImoveis, formatCurrency } from "@/lib/mock-data";
...
export default function ImoveisPage() {
  ...
  const filtered = mockImoveis.filter((im) => {
    ...
    <div className="px-4 pt-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        {filtered.map((imovel, i) => {
          const badge = statusBadge[imovel.status] || statusBadge.disponivel;
          return (
            <motion.div
              key={imovel.id}
            ...
            >
              ...
              <div className="p-3">
                <p className="text-[11px] text-muted-foreground mb-0.5">{imovel.tipo}</p>
                ...
                <p className="text-sm font-bold text-primary mb-2">{formatCurrency(imovel.preco)}</p>
